...
function calc() {
    ...
    function calcTotal() {
        if (!sex || !height  || !weight || !age || !ratio) {
            result.textContent = 'Заполните, пожалуйста, все поля формы для расчета';
...
function timer(id, deadline) {
    ...
    }//функция помощник. Для подставления нулей перед числами меньше 10
    ...
    function setClock(selector, endtime) {
        ...
        updateClock();//исправляет баг задержки на 1 сек оставшегося времени
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2020-12-21');
